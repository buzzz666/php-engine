		...
		<div class="blog-page main grid-wrap">
			...
			<section class="grid col-three-quarters mq2-col-two-thirds mq3-col-full">
				...
				<article class="post">
					...
					<div class="meta">
						<p>Posted on <span class="time"><?php echo $newsItem['date'] ?> by <a href="#" class="fn"><?php echo $newsItem['author'] ?></a></span>
					</div>
					<div class="entry">
					...
					<footer>
						<a href="/news/" class="article-link" class="more-link">-- Back to news list</a>
					</footer>
				</article>
